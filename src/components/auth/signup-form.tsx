...
const gradientTextClass = "bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-300"
...
export default function SignUpForm() {
  ...
  const onSubmitAdvertiser = async (data: FormValues) => {
    ...
    trackClick("Navigation", "Sign up form submited", "click")
    trackClick("Button", "Clicked signup button", "submit")
  ...
  const onVerifyOtp = async (values: OtpFormValues) => {
    trackClick("Otp verify", "otp verify code button clicked", "click")
    ...
    try {
      ...
      if (response.status === 201 || response.data.status === 201) {
        trackClick("email verify", "verify email clicked", "click")
  ...
  if (accountCreated) {
    return (
      <Card className="w-full mx-auto shadow-lg bg-slate-900 border-slate-800 text-slate-200">
        <CardHeader className="space-y-1">
          <CardTitle className={`text-2xl font-bold text-center ${gradientTextClass}`}>{tOtp("title")}</CardTitle>
          <CardDescription className="text-center text-slate-400">{tOtp("description")}</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...otpForm}>
            <form onSubmit={otpForm.handleSubmit(onVerifyOtp)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-slate-300">{tOtp("label")}</FormLabel>
                    <FormControl>
                      <Input
                        type="text"
                        inputMode="numeric"
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-400 to-cyan-300 hover:from-blue-500 hover:to-cyan-400 transition duration-200"
              >
                {verifyingOtp ? (
                  <>
        ...
        <CardFooter className="flex justify-center border-t border-slate-800 p-4">
          <div className="text-sm text-slate-400">{tOtp("footerRedirect")}</div>
        </CardFooter>
      </Card>
    )
  }
  ...
  return (
    <Card className="w-full mx-auto shadow-lg bg-slate-900 border-slate-800 text-slate-200">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center text-slate-400">{tRegister("subtitle")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form
                      ...
                      >
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem
                              value="publisher"
                              className="border-2 border-blue-600 text-white [&[data-state=checked]]:bg-gradient-to-r [&[data-state=checked]]:from-blue-600 [&[data-state=checked]]:to-cyan-600 [&[data-state=checked]]:border-0"
                            />
                          </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={tRegister("firstNamePlaceholder")} className="bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={tRegister("lastNamePlaceholder")} className="bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder={tRegister("emailPlaceholder")} className="bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder={tRegister("businessNamePlaceholder")} className="bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                        ...
                        <div className="flex">
                          <Select
                            ...
                            onValueChange={(value) => {
                              ...
                              const newCode = countryCodeMap[value as keyof typeof countryCodeMap]?.code || "+1"
                          ...
                          <Input
                            className="rounded-l-none bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500"
            ...
            {step === 4 && watchRole === "publisher" && (
              <>
                ...
                <FormField
                  ...
                  name="ownsSite"
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border border-slate-700 bg-slate-800/50 p-4">
                      <FormControl>
                        <Checkbox checked={field.value} onCheckedChange={field.onChange} />
                      </FormControl>
                      <div className="space-y-1 leading-none">
                        <FormLabel>{tRegister("publisherOwnsSiteLabel")}</FormLabel>
                        <p className="text-sm text-slate-400">{tRegister("publisherOwnsSiteDescription")}</p>
                      </div>
                    </FormItem>
                  )}
                />
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border border-slate-700 bg-slate-800/50 p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <p className="text-sm text-slate-400">{tRegister("publisherDoFollowDescription")}</p>
                      </div>
                    </FormItem>
                  )}
                />
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border border-slate-700 bg-slate-800/50 p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <p className="text-sm text-slate-400">{tRegister("publisherSellsArticlesDescription")}</p>
                      </div>
                    </FormItem>
                  )}
                />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input required placeholder={tRegister("publisherArticlesUrlPlaceholder")} className="bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder={tRegister("publisherReferralPlaceholder")} className="bg-slate-800 border-slate-700 text-slate-200 focus:border-blue-500" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="flex justify-between mt-6">
              {step > 1 && (
                <Button
                  ...
                  className="border-cyan-400 bg-slate-800 text-cyan-400"
                >
              ...
              {step < totalSteps ? (
                <Button
                  type="button"
                  onClick={nextStep}
                  className="ml-auto w-24 bg-gradient-to-r from-blue-400 to-cyan-300 hover:from-blue-500 hover:to-cyan-400 transition duration-200"
                >
                ...
                <Button
                  ...
                  disabled={isSubmitting}
                  className="ml-auto w-28 bg-gradient-to-r from-blue-400 to-cyan-300 hover:from-blue-500 hover:to-cyan-400 transition duration-200"
                >
                  {isSubmitting ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
      ...
      <CardFooter className="flex flex-col gap-4 border-t border-slate-800 p-4">
        <div className="text-sm font-medium bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-600">
          {tRegister("stepIndicator", { step: step, totalSteps: totalSteps })}
        </div>
        <div className="text-sm text-slate-400">
          {tRegister("have_account")}{" "}
          <Link href="/sign-in" className="font-medium text-blue-600 hover:text-cyan-600">
            {tRegister("login")}
          </Link>
        </div>
      </CardFooter>
